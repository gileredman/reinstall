...
脚本有更新，请重新下载 reinstall.sh"
    ...
    curl -Lo $initrd_dir/initrd-network.sh https://raw.githubusercontent.com/gileredman/reinstall/refs/heads/copilot/add-windows-reinstall-first-boot-script/initrd-network.sh
